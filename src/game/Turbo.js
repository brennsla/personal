...
export class Turbo {
 constructor(scene,track,controller,root){
  ...
  this.el=document.createElement('div');this.el.style.cssText='position:fixed;bottom:70px;right:28px;padding:14px 18px;background:#08222ddb;border:1px solid #53dfff;color:white;min-width:200px;pointer-events:none;font:16px sans-serif';
